...
const tom = new Cat('Tom', 12, 'red')
console.log(tom.catName)
...
class Wizard {
  constructor(name, age, favoriteSpell) {
    this.wizName = name;
    this.wizAge = age;
    this.wizFavoriteSpell = favoriteSpell;
  }
    castSpell() {
      console.log(`${this.wizName} has cast ${this.wizFavoriteSpell}`);
    }
  }

const Harry = new Wizard('Harry Potter', 21, 'Dragons Breath' );
...
let phoneOne = new Phone('Apple', 'iPhone', 128, 'Navy', 500)
let phoneTwo = new Phone('Apple', 'iPhone', 64, 'Red', 250)
let phoneThree = new Phone('Apple', 'iPhone', 32, 'Pink', 125)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(1, 'Red', 2500, 'Subaru', true)
...
//Code Here
let myFirstBoat = new Boat(5, 'Blue', 500, 'Saily', 'Sail Boat', false)
/*
